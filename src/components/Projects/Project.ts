...
import scada from '@/app/imgs/scada.jpg';
import learn from '@/app/imgs/LEARN.jpg';
import mag from '@/app/imgs/Magasinn.jpg';
...
const project_Agence: project = new project("Agency app", agence, "https://github.com/Chahin18/Project-Agency-PostgreSQL", 600, 300);
const project_weather: project = new project("Weather app", weather, "https://github.com/Chahin18/Project-Weather", 600, 300);
const project_store: project = new project("E-commerce app", store, "https://e-commerce-mern-j5xg.vercel.app/", 600, 300);
const project_blog: project = new project("Savage Blog", blog, "https://github.com/Chahin18/Project-Blog-MERN", 600, 300);
const project_files: project = new project("Savage Files", files, "https://savage-files.vercel.app", 600, 300);
const project_scada: project = new project("SCADATECH", scada, "https://github.com/Chahin18/Project-SCADA-MEAN", 600, 300);
const project_learn: project = new project("LearnHub", learn, "https://github.com/Chahin18/Project-SCADA-MEAN", 600, 300);
const project_Magasin: project = new project("Magasin", mag, "https://github.com/Chahin18/Project-Magasin-MVC", 600, 300);


const AllProjects : Array<project> = [project_Magasin,project_learn,project_scada,project_Agence,project_weather, project_store, project_blog, project_files];
...
const AllGames: Array<project> = [project_learn,project_scada,project_gems, project_sliding, project_memory];
